    ...
    <div className="relative z-20 min-h-screen py-20 md:py-32 px-6 md:px-12 lg:px-24">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 md:mb-24 max-w-4xl reveal">
          ...
          <h2 className="text-4xl md:text-7xl font-light mb-6 md:mb-8">Clinomic <span className="font-medium">Labs</span></h2>
           ...
           <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8 reveal stagger-2">
                <div className="glass-effect p-8 rounded-[32px] border border-white/10 hover:border-blue-400/20 hover:-translate-y-1 transition-all duration-500">
                   <h4 className="text-blue-300 text-[9px] font-bold uppercase tracking-widest mb-4">How it interprets</h4>
                   ...
                   <div className="space-y-3">
                      <div className="flex gap-3 items-center">
                        ...
                        <span className="text-[11px] text-white/90">Macro-ovalocytic trends in MCV & RBC indices</span>
                      </div>
                      <div className="flex gap-3 items-center">
                        <div className="w-1.5 h-1.5 rounded-full bg-blue-400"></div>
                        <span className="text-[11px] text-white/90">Subtle changes in anisocytosis (RDW-CV/SD)</span>
                      </div>
                      <div className="flex gap-3 items-center">
                        <div className="w-1.5 h-1.5 rounded-full bg-blue-400"></div>
                        <span className="text-[11px] text-white/90">Secondary signatures in WBC/Platelet distributions</span>
                      </div>
                   </div>
                </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 md:gap-20 mb-20 md:mb-40">
          <div className="space-y-8 md:space-y-12 reveal-left">
            <div className="group">
              ...
              <p className="text-white font-light text-sm md:text-base leading-relaxed opacity-80 group-hover:opacity-100 transition-opacity">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
              {[
                ...
                <div key={idx} className="flex items-center gap-3 group/item">
                  ...
                  <span className="text-[11px] md:text-xs text-white font-medium group-hover/item:text-blue-200 transition-colors">{item}</span>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-12 md:gap-2 lg:gap-4 md:px-2 lg:px-4">
              {steps.map((step, i) => (
                <div key={i} className={`relative z-10 flex flex-col items-center text-center group reveal stagger-${(i % 3) + 1}`}>
                  ...
                  <h4 className="text-[10px] md:text-[9px] lg:text-xs font-bold mb-2 md:mb-3 tracking-wide text-white group-hover:text-blue-300 transition-colors uppercase md:h-8 flex items-center px-1 lg:px-4 leading-tight">{step.label}</h4>
                  <p className="text-[10px] md:text-[9px] lg:text-[11px] text-white/80 font-light leading-relaxed max-w-[200px] md:max-w-[140px] lg:max-w-[160px] group-hover:text-white transition-colors">{step.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 md:gap-24 items-center">
                ...
                <div className="flex flex-col gap-4">
                  {[
                    ...
                    <div key={idx} className="glass-effect p-6 rounded-2xl border border-white/20 hover:border-blue-400/40 hover:-translate-x-1 transition-all duration-500 group">
                      <div className="text-xs md:text-sm font-bold text-blue-300 uppercase tracking-widest mb-1 group-hover:text-blue-400 transition-colors">{item.t}</div>
                      <p className="text-[10px] md:text-xs text-white/80 font-light group-hover:text-white transition-colors">{item.d}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="relative reveal-right stagger-1">
              <div className="glass-effect aspect-auto md:aspect-square min-h-[480px] rounded-[40px] md:rounded-[60px] border border-white/10 p-8 md:p-12 flex flex-col justify-center relative overflow-hidden group hover:border-blue-400/20 transition-all duration-700">
                ...
                <p className="text-white/80 text-xs md:text-sm font-light text-center leading-relaxed mb-8 md:mb-12 group-hover:text-white transition-colors">
