    ...
    <div className="relative z-20 min-h-screen py-20 md:py-32 px-6 md:px-12 lg:px-24 bg-gradient-to-t from-blue-900/5 to-transparent flex flex-col justify-center">
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-16 md:gap-20 items-start">
        <div className="space-y-12 md:space-y-16">
          <h2 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-light tracking-tighter leading-[1] md:leading-[0.9]">
            Get <br />
            <span className="text-blue-300 font-medium">In Touch.</span>
          </h2>
          
          <p className="text-white/75 text-base md:text-xl font-light max-w-md leading-relaxed">
            Let’s enable earlier detection—without changing how labs work.
          </p>
          
          <div className="space-y-8 md:space-y-12">
            <div className="group">
              <span className="text-[9px] md:text-[10px] text-white/50 uppercase tracking-[0.3em] font-bold mb-3 md:mb-4 block">Product & Partnerships</span>
              <a href="mailto:contact@arogyabiox.com" className="text-lg sm:text-2xl md:text-4xl font-light text-white group-hover:text-blue-300 transition-colors duration-300 break-all leading-tight">
      ...
      <div className="mt-16 md:mt-24 pt-8 md:pt-12 border-t border-white/10 text-center px-4 md:px-6">
        <p className="text-[8px] md:text-[10px] text-white/40 uppercase tracking-[0.3em] md:tracking-[0.4em] leading-relaxed max-w-5xl mx-auto">
