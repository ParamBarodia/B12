    ...
    <div className="relative z-20 py-20 md:py-40 px-6 md:px-12 lg:px-24 flex flex-col justify-center">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-start">
          <div>
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-light mb-8 md:mb-12 leading-tight tracking-tight">
            ...
            <p className="text-white text-base md:text-lg lg:text-xl font-light leading-relaxed mb-6 md:mb-8">
            ...
            <div className="space-y-4 md:space-y-6 text-white text-sm md:text-base font-light leading-relaxed">
              ...
              <p className="italic text-blue-300 text-xs md:text-sm font-medium">"We design every product as a clinical decision support system, not a diagnostic replacement."</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:gap-12">
            <div className="glass-effect p-6 md:p-10 rounded-3xl border border-white/20 hover:border-blue-400/30 hover:-translate-y-1 hover:bg-white/[0.04] transition-all duration-500 group">
              <h3 className="text-blue-300 text-[10px] font-bold uppercase tracking-widest mb-6 md:mb-8 group-hover:text-blue-400 transition-colors">Our Approach</h3>
              <ul className="space-y-4 md:space-y-5">
                {[
                  ...
                  <li key={idx} className="flex items-center gap-3 md:gap-4 group/item">
                    ...
                    <span className="text-xs md:text-base text-white font-light group-hover/item:text-blue-50 transition-colors">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
